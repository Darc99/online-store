...
public class ProductOrderService {
  ...
  public Page<ProductOrder> findAll(Pageable pageable) {
    ...
    } else return productOrderRepository.findAllByCustomerUserLogin(SecurityUtils.getCurrentUserLogin().get(), pageable);
  }
  ...
  public Optional<ProductOrder> findOne(Long id) {
    ...
    if (SecurityUtils.isCurrentUserInRole(AuthoritiesConstants.ADMIN)) {
      return productOrderRepository.findById(id);
    } else return productOrderRepository.findOneByIdAndCustomerUserLogin(id, SecurityUtils.getCurrentUserLogin().get());
  }
