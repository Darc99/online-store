...
import com.darc.store.domain.Product;
import com.darc.store.domain.ProductOrder;
import com.darc.store.domain.enumeration.OrderItemStatus;
import com.darc.store.repository.OrderItemRepository;
import com.darc.store.service.OrderItemService;
...
public class OrderItemResourceIT {
  ...
  public void createOrderItem() throws Exception {
    ...
    restOrderItemMockMvc
      .perform(post("/api/order-items").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(orderItem)))
  ...
  public void updateOrderItem() throws Exception {
    ...
    restOrderItemMockMvc
      .perform(put("/api/order-items").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedOrderItem)))
      .andExpect(status().isOk());
  ...
  public void updateNonExistingOrderItem() throws Exception {
    ...
    restOrderItemMockMvc
      .perform(put("/api/order-items").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(orderItem)))
      .andExpect(status().isBadRequest());
