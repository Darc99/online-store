package com.darc.store.web.rest;
...
import com.darc.store.StoreApp;
import com.darc.store.domain.Customer;
import com.darc.store.domain.ProductOrder;
import com.darc.store.domain.enumeration.OrderStatus;
import com.darc.store.repository.ProductOrderRepository;
import com.darc.store.service.ProductOrderService;
...
public class ProductOrderResourceIT {
  ...
  public void createProductOrder() throws Exception {
    ...
    restProductOrderMockMvc
      .perform(post("/api/product-orders").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(productOrder)))
  ...
  public void updateProductOrder() throws Exception {
    ...
    restProductOrderMockMvc
      .perform(
        put("/api/product-orders").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedProductOrder))
      )
      .andExpect(status().isOk());
  ...
  public void updateNonExistingProductOrder() throws Exception {
    ...
    restProductOrderMockMvc
      .perform(put("/api/product-orders").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(productOrder)))
      .andExpect(status().isBadRequest());
  ...
  public void deleteProductOrder() throws Exception {
    ...
    restProductOrderMockMvc
      .perform(delete("/api/product-orders/{id}", productOrder.getId()).accept(MediaType.APPLICATION_JSON))
