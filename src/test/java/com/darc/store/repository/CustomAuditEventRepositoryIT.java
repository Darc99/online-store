...
import com.darc.store.config.audit.AuditEventConverter;
import com.darc.store.domain.PersistentAuditEvent;
...
import static com.darc.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
